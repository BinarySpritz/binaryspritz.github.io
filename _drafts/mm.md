...
Thus, when an exercise asks you to compute the complexity of a divide and conquer algorithm, it is essentially asking you to solve a recurrence relation. The master method provides a way to solve specific types of recurrence relations.
...
<!-- $$ \exists k > 0 \text{ such that }  \leq  4 \left(\frac{n}{2}\right)^2 \sqrt{\frac{n}{2}} \leq k n^2 \sqrt{n} $$ -->
